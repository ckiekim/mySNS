<%@ page language="java" contentType="text/html;charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.*, mysns.member.*, mysns.sns.*"%>
		...
		<section id="main">
			<section id="content">
				...
				<div id="accordion">
					...
					Message message = (Message)pageContext.getAttribute("m");
					Member member = memDao.getOneMember(message.getUid());
					pageContext.setAttribute("memName", member.getName());
					%>
					<h3>[${memName}]${m.msg} :: [좋아요 ${m.favcount} | 댓글 ${m.replycount}]</h3>
					<div>
						<p></p>
			...
			<aside id="sidebar2">
				...
				<c:forEach items="${memberList}" var="member">
					<ul>
						<li><a href="sns_control.jsp?action=getall&suid=${member.uid}">${member.name}</a></li>
					</ul>
				</c:forEach>
				...
				<h3>Links</h3>
				<ul>
					<li><a href="#">이젠아카데미</a></li>
					<li><a href="#">한빛미디어</a></li>
					<li><a href="#">국가직무능력표준(NCS)</a></li>
				</ul>
